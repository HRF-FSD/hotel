...
public class websiteuser extends JFrame {
    ...
    private void loaduserData() {
        try {
            ...
            String query = "SELECT id, name, email, Password FROM client";
        ...
        if (selectedRowIndex != -1) {
            ...
            try {
                ...
                if (affectedRows > 0) {
                    ...
                    JOptionPane.showMessageDialog(this, "Failed to delete employee.", "Deletion Failed",
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {
        Home_Hotel anotherPage = new Home_Hotel();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new websiteuser().setVisible(true);
            }
        });
        ;
